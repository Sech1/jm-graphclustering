...
{
    public class HyperVATDeg : IClusteringAlgorithm
    {
        ...
        public HyperVATDeg(LightWeightGraph lwg, bool reassignNodes = true, double alpha = 1.0f, double beta = 0.0f, List<int> nodeRemovalOrder = null, int numNodesRemoved = 0)
        {
