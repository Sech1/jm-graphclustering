...
{
    public class Scattering : IClusteringAlgorithm
    {
        ...
        public Scattering(LightWeightGraph lwg, bool reassignNodes = true, double alpha = 1.0f, double beta = 0.0f)
        {
        ...
        //Use GetComponents
        private double CalculateScattering(bool[] s)
        {
            ...
            //calculate scattering = 1/(#connectedComponents +
            double sn = (double)1/(components.Count - sizeS + 1);
            if (sn<0)
            {
                return 1;
            } else
        ...
        public void HillClimbOrig()
        {
            ...
            while (i < g.NumNodes)
            {
                ...
                s[i] ^= true;
                double vat = CalculateScattering(s);
                if (vat < bestVAT)
                {
                    bestVAT = vat;
                    i = 0;
